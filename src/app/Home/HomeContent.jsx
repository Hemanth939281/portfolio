...
const HomeContent = ({name, description}) => {
    ...
    return (
        <div className="">
            <div className="text-white text-lg max-w-full lg:mx-28 lg:mt-[5%] flex flex-col lg:flex-row gap-16 lg:gap-36 items-center justify-center p-6">
            ...
            <Image width={200} height={200} src="/hemanth.jpg" alt="ProfilePhoto" className="lg:hover:reflect rounded-tr-full rounded-tl-full w-96 h-[19rem] transition duration-300 ease-in-out"  />
        </div>
        </div>
    )
}
